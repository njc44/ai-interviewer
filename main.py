...
os.environ['GOOGLE_API_KEY'] = 'ENTER_YOUR_KEY'
...
# QUESTION_BANK = {
#     "technical": [
#         # "Can you explain what feature scaling is and when it's necessary?",
...
#         "What tools and libraries do you commonly use for data visualization?",
...
# System prompt for the interviewer personality
INTERVIEWER_PROMPT = """
You are an experienced AL/ML engineer and data science interview coach. Your role is to:
1. Ask questions some good questions that could be asked in an interview for SWE3 AI/ML at google
2. Listen carefully to the candidate's responses
3. Ask relevant follow-up questions based on their answers
4. Provide constructive feedback and tell how they could have done better on structure, delivery, answer etc.
6. Give immediate feedback to the candidate.
"""


CONFIG = {"generation_config": {"response_modalities": ["AUDIO"]},  "system_instruction":f"{INTERVIEWER_PROMPT}"}#+f"\n\nQuestion Bank: {QUESTION_BANK}"}
